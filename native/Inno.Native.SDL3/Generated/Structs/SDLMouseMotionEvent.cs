...
namespace Inno.Native.SDL3
{
	...
	public partial struct SDLMouseMotionEvent
	{
		...
		public unsafe SDLMouseMotionEvent(SDLEventType type = default, uint reserved = default, ulong timestamp = default, uint windowID = default, uint which = default, uint state = default, float x = default, float y = default, float xrel = default, float yrel = default)
		{
			Type = type;
			Reserved = reserved;
			Timestamp = timestamp;
