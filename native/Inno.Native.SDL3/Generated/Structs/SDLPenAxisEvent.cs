...
namespace Inno.Native.Sdl3
{
	...
	public partial struct SDLPenAxisEvent
	{
		...
		public unsafe SDLPenAxisEvent(SDLEventType type = default, uint reserved = default, ulong timestamp = default, uint windowID = default, uint which = default, uint penState = default, float x = default, float y = default, SDLPenAxis axis = default, float value = default)
		{
			Type = type;
			Reserved = reserved;
			Timestamp = timestamp;
