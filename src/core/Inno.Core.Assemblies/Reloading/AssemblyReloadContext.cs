...
public sealed class AssemblyReloadContext
{
    ...
    /// </summary>
    /// <typeparam name="TContext">The requested participant context type.</typeparam>
    /// <returns>The matching context.</returns>
    ...
    /// </summary>
    /// <typeparam name="TContext">The requested participant context type.</typeparam>
    /// <param name="context">Receives the matching context when found.</param>
    /// <returns><see langword="true"/> when exactly one matching context exists.</returns>
