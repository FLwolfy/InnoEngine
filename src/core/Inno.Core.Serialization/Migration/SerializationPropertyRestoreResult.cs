...
public sealed class SerializationPropertyRestoreResult
{
    ...
    /// <summary>Gets the number of properties successfully restored.</summary>
    public int restoredCount { get; }

    /// <summary>Gets the number of removed or non-deserializable properties ignored by schema matching.</summary>
    public int ignoredCount { get; }

    /// <summary>Gets properties skipped because their previous data was incompatible.</summary>
    public IReadOnlyList<SerializationPropertyRestoreFailure> failures { get; }

    /// <summary>Gets whether every matching property was restored successfully.</summary>
