...
public readonly struct DiagnosticLocation : IEquatable<DiagnosticLocation>
{
    ...
    /// </summary>
    /// <param name="sourcePath">The source path associated with the diagnostic.</param>
    /// <param name="line">The one-based line number, or zero when it is unavailable.</param>
    /// <param name="column">The one-based column number, or zero when it is unavailable.</param>
    ...
    /// <returns><see langword="true"/> when both locations identify the same source position.</returns>
    ...
    /// <param name="left">The left location.</param>
    /// <param name="right">The right location.</param>
    /// <returns><see langword="true"/> when the locations identify different source positions.</returns>
    public static bool operator !=(DiagnosticLocation left, DiagnosticLocation right)
        => !left.Equals(right);
}
