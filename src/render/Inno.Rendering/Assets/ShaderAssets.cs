...
/// <summary>Identifies a programmable shader stage.</summary>
[Flags]
...
/// <summary>Identifies an artist-facing shader property type.</summary>
public enum ShaderPropertyType
{
    ...
    TextureCube,
    /// <summary>Read-only or read-write buffer.</summary>
    Buffer
}

/// <summary>Defines how one shader property enters the backend-neutral resource interface.</summary>
public enum ShaderPropertyBindingKind
{
    /// <summary>Vector or matrix uniform data.</summary>
    Uniform,
    /// <summary>Texture sampled through an explicit material sampler.</summary>
    SampledTexture,
    /// <summary>Texture bound for unordered shader access by a Pipeline.</summary>
    StorageTexture,
    /// <summary>Buffer bound for unordered shader access by a Pipeline.</summary>
    StorageBuffer
}

/// <summary>Selects the programmable stage combination of a pass.</summary>
public enum ShaderProgramKind
{
    /// <summary>Vertex and fragment stages used by a raster pass.</summary>
    Raster,
    /// <summary>A compute stage used by a compute pass.</summary>
    Compute
}

/// <summary>Selects the triangle face rejected by a raster pass.</summary>
public enum ShaderCullMode
{
    /// <summary>Does not reject either face orientation.</summary>
    None,
    /// <summary>Rejects front-facing triangles.</summary>
    Front,
    /// <summary>Rejects back-facing triangles.</summary>
    Back
}

/// <summary>Selects the comparison used by depth testing.</summary>
...
/// <summary>Declares backend-neutral fixed-function state for one shader pass.</summary>
public struct ShaderRenderState
{
    ...
    /// <summary>Gets or sets the primitive assembly used by raster draws.</summary>
    public RenderPrimitiveTopology topology { get; set; }

    /// <summary>Gets or sets the face culling mode.</summary>
    public ShaderCullMode cull { get; set; }

    /// <summary>Gets or sets the winding order interpreted as the front face.</summary>
    public RenderFrontFace frontFace { get; set; }

    /// <summary>Gets or sets the depth comparison function.</summary>
    public ShaderCompareFunction depthCompare { get; set; }

    /// <summary>Gets or sets whether accepted fragments update depth.</summary>
    public bool depthWrite { get; set; }

    /// <summary>Gets or sets independent RGB and alpha blending.</summary>
    public RenderBlendState blend { get; set; }

    /// <summary>Gets or sets the four-bit RGBA color write mask.</summary>
    public byte colorWriteMask { get; set; }

    /// <summary>Gets or sets whether compatible targets use multisample rasterization.</summary>
    public bool multisampling { get; set; }
}

/// <summary>Identifies a material property using a stable serialized string.</summary>
public record struct ShaderPropertyId
{
    /// <summary>Creates a stable shader property identifier.</summary>
    ...
    /// <summary>Gets or sets the stable manifest property identifier.</summary>
    public string value { get; set; }

    /// <summary>Gets whether this identifier has a usable value.</summary>
...
/// <summary>Identifies an open shader and pipeline compatibility contract.</summary>
public record struct ShaderContractId
{
    /// <summary>Creates a shader contract identifier.</summary>
    /// <param name="value">Globally stable contract value.</param>
    ...
    /// <summary>Gets or sets the globally stable contract value.</summary>
    public string value { get; set; }

    /// <summary>Gets whether the identifier has a usable value.</summary>
    public readonly bool isValid => !string.IsNullOrWhiteSpace(value);
...
/// <summary>Identifies one material-selectable technique in a shader.</summary>
public record struct ShaderTechniqueId
{
    /// <summary>Creates a shader technique identifier.</summary>
    /// <param name="value">Stable technique value within a shader.</param>
    ...
    /// <summary>Gets or sets the stable technique value.</summary>
    public string value { get; set; }
...
/// <summary>Identifies an open pass purpose defined by a rendering provider.</summary>
public record struct ShaderPassRoleId
{
    /// <summary>Creates a shader pass role identifier.</summary>
    /// <param name="value">Stable role value within a contract.</param>
    ...
    /// <summary>Gets or sets the stable role value.</summary>
    public string value { get; set; }
...
/// <summary>Stores one open metadata key and value.</summary>
public struct ShaderMetadataEntry
{
    /// <summary>Creates one metadata entry.</summary>
...
/// <summary>Declares one shader property and its reflected stage visibility.</summary>
public struct ShaderPropertyDefinition
{
    /// <summary>Creates a shader property definition.</summary>
    ...
    /// <param name="defaultValue">Native serializable default value.</param>
    ...
    /// </param>
    /// <param name="storageAccess">Required access for storage texture or buffer bindings.</param>
    ...
    /// <summary>Gets or sets the stable property identifier.</summary>
    public ShaderPropertyId id { get; set; }

    /// <summary>Gets or sets the artist-facing property name.</summary>
    public string displayName { get; set; }

    /// <summary>Gets or sets the property type.</summary>
    public ShaderPropertyType type { get; set; }

    /// <summary>Gets or sets stages that access the property.</summary>
    public ShaderStage stages { get; set; }

    /// <summary>Gets or sets the native serializable default value.</summary>
    public MaterialValue defaultValue { get; set; }

    /// <summary>Gets or sets how the property enters the shader resource interface.</summary>
    public ShaderPropertyBindingKind bindingKind { get; set; }

    /// <summary>Gets or sets required access for storage texture or buffer bindings.</summary>
...
/// <summary>Declares one static shader keyword that may produce compiled variants.</summary>
public struct ShaderKeywordDefinition
{
    /// <summary>Creates a shader keyword definition.</summary>
    ...
    /// <summary>Gets or sets the stable keyword identifier.</summary>
    public string id { get; set; }

    /// <summary>Gets or sets allowed stable option identifiers.</summary>
    public string[] options { get; set; }
}

/// <summary>Represents shaderc-compatible source imported through the common asset system.</summary>
[StableTypeId("80356429-c04e-4cf0-b32e-ebda7ed8d428")]
public sealed class ShaderSourceAsset : AssetObject
{
    /// <summary>Gets or sets decoded source text.</summary>
    [SerializableProperty]
    public string content { get; internal set; } = string.Empty;
}

/// <summary>Defines one backend-neutral raster or compute shader pass.</summary>
public struct ShaderPassDefinition
{
    /// <summary>Creates a shader pass definition.</summary>
    /// <param name="name">Stable pass name within the shader.</param>
    /// <param name="programKind">Programmable stage combination.</param>
    /// <param name="vertexSource">Optional vertex source asset.</param>
    /// <param name="fragmentSource">Optional fragment source asset.</param>
    /// <param name="computeSource">Optional compute source asset.</param>
    /// <param name="varyingSource">Optional varying definition source asset.</param>
    ...
    /// <param name="metadata">Optional provider-defined metadata.</param>
    ...
    /// <summary>Gets or sets the stable pass name.</summary>
    public string name { get; set; }

    /// <summary>Gets or sets the programmable stage combination.</summary>
    public ShaderProgramKind programKind { get; set; }

    /// <summary>Gets or sets the vertex source asset.</summary>
    public ShaderSourceAsset? vertexSource { get; set; }

    /// <summary>Gets or sets the fragment source asset.</summary>
    public ShaderSourceAsset? fragmentSource { get; set; }

    /// <summary>Gets or sets the compute source asset.</summary>
    public ShaderSourceAsset? computeSource { get; set; }

    /// <summary>Gets or sets the varying definition source asset.</summary>
    public ShaderSourceAsset? varyingSource { get; set; }

    /// <summary>Gets or sets required device capabilities.</summary>
    public GraphicsFeature requiredFeatures { get; set; }

    /// <summary>Gets or sets backend-neutral fixed-function state.</summary>
    public ShaderRenderState renderState { get; set; }

    /// <summary>Gets or sets provider-defined metadata.</summary>
    public ShaderMetadataEntry[] metadata { get; set; }
}

/// <summary>Maps one provider-defined role to one concrete shader pass.</summary>
public struct ShaderTechniquePass
{
    /// <summary>Creates a technique pass mapping.</summary>
    /// <param name="role">Open role defined by the technique contract.</param>
    /// <param name="passName">Concrete pass name within the shader.</param>
    ...
    /// <summary>Gets or sets the provider-defined role.</summary>
    public ShaderPassRoleId role { get; set; }

    /// <summary>Gets or sets the concrete pass name.</summary>
    public string passName { get; set; }
}

/// <summary>Declares one contract-compatible pass mapping selectable by materials.</summary>
public struct ShaderTechniqueDefinition
{
    /// <summary>Creates a shader technique definition.</summary>
    /// <param name="id">Stable technique identifier.</param>
    /// <param name="contract">Open rendering-provider contract.</param>
    /// <param name="passes">Role-to-pass mappings.</param>
    /// <param name="requiredFeatures">Capabilities required by the complete technique.</param>
    ...
    /// <summary>Gets or sets the stable technique identifier.</summary>
    public ShaderTechniqueId id { get; set; }

    /// <summary>Gets or sets the open rendering-provider contract.</summary>
    public ShaderContractId contract { get; set; }

    /// <summary>Gets or sets role-to-pass mappings.</summary>
    public ShaderTechniquePass[] passes { get; set; }

    /// <summary>Gets or sets capabilities required by the complete technique.</summary>
    public GraphicsFeature requiredFeatures { get; set; }
}

/// <summary>Contains the source-of-truth definition shared by handwritten and graph shaders.</summary>
public sealed class ShaderDefinition : ISerializable
{
    /// <summary>Creates an empty shader definition for native deserialization.</summary>
    public ShaderDefinition()
    {
    }

    /// <summary>Creates a shader definition.</summary>
    ...
    /// <param name="passes">Backend-neutral pass declarations.</param>
    /// <param name="techniques">Open contract and role mappings.</param>
    public ShaderDefinition(
        string name,
    ...
    /// <summary>Gets or sets the artist-facing shader name.</summary>
    [SerializableProperty]
    public string name { get; set; } = string.Empty;

    /// <summary>Gets or sets stable property declarations.</summary>
    [SerializableProperty]
    public ShaderPropertyDefinition[] properties { get; set; } = [];

    /// <summary>Gets or sets static keyword declarations.</summary>
    [SerializableProperty]
    public ShaderKeywordDefinition[] keywords { get; set; } = [];

    /// <summary>Gets or sets backend-neutral pass declarations.</summary>
    [SerializableProperty]
    public ShaderPassDefinition[] passes { get; set; } = [];

    /// <summary>Gets or sets open contract and role mappings.</summary>
    [SerializableProperty]
    public ShaderTechniqueDefinition[] techniques { get; set; } = [];
}

/// <summary>Represents an imported handwritten or generated shader definition.</summary>
...
public class ShaderAsset : AssetObject
{
    ...
    /// <summary>Commits a validated definition through the native serialization channel.</summary>
    /// <param name="value">Complete definition visible to materials and target compilation.</param>
    public void SetDefinition(ShaderDefinition value)
    {
        ArgumentNullException.ThrowIfNull(value);
        m_definitionData = SerializationManager.Serialize(value);
    ...
    private void OnSerializableRestored()
    {
        definition = m_definitionData.Length == 0
            ? null
            : SerializationManager.Deserialize<ShaderDefinition>(m_definitionData);
    }
}

/// <summary>Selects how texture samples are decoded for shader use.</summary>
public enum TextureColorSpace
{
    /// <summary>Samples are interpreted as linear values.</summary>
    Linear,
    /// <summary>Color samples are decoded from sRGB at sampling time.</summary>
    Srgb
}

/// <summary>Represents imported texture content without owning a GPU handle.</summary>
...
/// <summary>Represents imported geometry without prescribing scene or draw semantics.</summary>
[StableTypeId("f214637e-0a54-438d-8a72-9d892bd29a56")]
public sealed class GeometryAsset : AssetObject
{
    /// <summary>Gets the number of normalized vertices.</summary>
    [SerializableProperty]
    ...
    /// <summary>Gets the number of independently submitted geometry sections.</summary>
    [SerializableProperty]
    public int sectionCount { get; internal set; }

    /// <summary>Gets the object-space center of imported geometry bounds.</summary>
    [SerializableProperty]
    public Vector3 boundsCenter { get; internal set; }

    /// <summary>Gets the non-negative object-space half-extents of imported geometry bounds.</summary>
    [SerializableProperty]
