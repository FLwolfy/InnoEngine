...
public sealed class RenderTexture
{
    ...
    /// </summary>
    /// <param name="name">Artist-facing and diagnostic name.</param>
    /// <param name="descriptor">Initial texture requirements.</param>
    ...
    /// <summary>Gets the artist-facing and diagnostic name.</summary>
    public string name { get; }

    /// <summary>Gets the current texture requirements.</summary>
    public RenderTextureDescriptor descriptor => m_descriptor;

    /// <summary>Gets a counter incremented whenever the descriptor changes.</summary>
    public long contentRevision { get; private set; }

    /// <summary>
    /// Replaces texture requirements at the next render-frame safety point.
    /// </summary>
    /// <param name="descriptor">New texture requirements.</param>
...
{
    /// <summary>Main application window swapchain.</summary>
    Backbuffer,
    /// <summary>Persistent offscreen render texture.</summary>
    Texture
}
...
public readonly record struct RenderTarget
{
    ...
    /// <summary>Gets a target representing the main application backbuffer.</summary>
    ...
    /// <summary>Gets the offscreen texture, or <see langword="null"/> for the backbuffer.</summary>
    public RenderTexture? texture { get; }

    /// <summary>
    /// Creates an offscreen render target.
    /// </summary>
    /// <param name="texture">Persistent offscreen texture description.</param>
    /// <returns>A target referencing <paramref name="texture"/>.</returns>
