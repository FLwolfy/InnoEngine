...
public sealed class AudioProcessorConfiguration
{
    ...
    /// </summary>
    public IReadOnlyList<AudioProcessorParameter> parameters => Array.AsReadOnly(m_parameters);
}
...
public sealed class AudioBusDefinition
{
    ...
    /// </summary>
    public IReadOnlyList<AudioProcessorConfiguration> processors => Array.AsReadOnly(m_processors);
}
...
public sealed class AudioMixer
{
    ...
    /// </summary>
    public IReadOnlyList<AudioBusDefinition> buses => Array.AsReadOnly(m_buses);
}
