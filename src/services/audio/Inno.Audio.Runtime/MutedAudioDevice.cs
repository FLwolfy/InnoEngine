...
public sealed class MutedAudioDevice : AudioDevice, IAudioDevice
{
    ...
    private readonly AudioDeviceLimits m_limits;
    ...
    AudioClipState IAudioDevice.GetClipState(AudioClipHandle clip)
    {
        ...
        return identity.generation == generation && m_clips.ContainsKey(identity.value)
            ? AudioClipState.Ready : AudioClipState.Failed;
    }
