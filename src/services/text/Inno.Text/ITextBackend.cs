...
{
    /// <summary>Loads one face from encoded OpenType data.</summary>
    ...
    /// <summary>Releases one loaded face.</summary>
    /// <param name="font">The face handle to release.</param>
    void ReleaseFont(TextFontHandle font);

    /// <summary>Shapes one Unicode string into positioned glyphs.</summary>
    ...
    /// <summary>Rasterizes one shaped glyph into 8-bit coverage.</summary>
    /// <param name="font">The loaded face.</param>
