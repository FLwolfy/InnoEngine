...
public sealed class RenderViewTransform
{
    ...
    /// <summary>
    /// Gets the immutable column-major view matrix.
    /// </summary>
    public ReadOnlyMemory<float> viewMatrix => m_viewMatrix;

    /// <summary>
    /// Gets the immutable column-major projection matrix.
    /// </summary>
...
public sealed class CompiledRenderTexture
{
    ...
    /// <summary>
    /// Gets the frame-scoped logical handle.
    /// </summary>
    public RenderTextureHandle handle { get; }

    /// <summary>
    /// Gets the debug and diagnostic name.
    /// </summary>
    public string name { get; }

    /// <summary>
    /// Gets texture requirements.
    /// </summary>
    public RenderTextureDescriptor descriptor { get; }

    /// <summary>
    /// Gets whether the resource was imported from persistent device state.
    /// </summary>
    public bool imported { get; }

    /// <summary>
    /// Gets the persistent device texture for imported resources.
    /// </summary>
    public PersistentTextureHandle persistentHandle { get; }

    /// <summary>
    /// Gets the aliasing allocation slot, or negative one for imported resources.
    /// </summary>
...
public sealed class CompiledRenderBuffer
{
    ...
    /// <summary>
    /// Gets the persistent device buffer for imported resources.
    /// </summary>
...
public sealed class CompiledRenderAttachment
{
    ...
    /// <summary>
    /// Gets the attached graph texture.
    /// </summary>
    public RenderTextureHandle texture { get; }

    /// <summary>
    /// Gets the zero-based color slot, or zero for a depth attachment.
    /// </summary>
    public int slot { get; }

    /// <summary>
    /// Gets whether this is a depth or depth-stencil attachment.
    /// </summary>
    public bool isDepth { get; }

    /// <summary>
    /// Gets the attached mip level.
    /// </summary>
    public int mipLevel { get; }

    /// <summary>
    /// Gets the attached texture-array layer.
    /// </summary>
    public int arrayLayer { get; }

    /// <summary>
    /// Gets initial content behavior.
    /// </summary>
    public RenderLoadAction loadAction { get; }

    /// <summary>
    /// Gets final content behavior.
    /// </summary>
    public RenderStoreAction storeAction { get; }

    /// <summary>
    /// Gets the linear color clear value.
    /// </summary>
...
public sealed class CompiledRenderPass
{
        ...
        Action<RenderPassContext> execute)
    {
        ...
        m_attachments = Array.AsReadOnly(attachments.ToArray());
    ...
    /// <summary>
    /// Gets the unique diagnostic name.
    /// </summary>
    public string name { get; }

    /// <summary>
    /// Gets the open render phase identifier.
    /// </summary>
    public RenderPhaseId phase { get; }

    /// <summary>
    /// Gets the pass command domain.
    /// </summary>
    public RenderPassKind kind { get; }

    /// <summary>
    /// Gets the backend-neutral logical view order.
    /// </summary>
    public int viewIndex { get; }

    /// <summary>
    /// Gets raster attachments in declaration order.
    /// </summary>
    public IReadOnlyList<CompiledRenderAttachment> attachments => m_attachments;

    /// <summary>
    /// Gets the detached presentation surface, or an invalid handle for the primary backbuffer.
    /// </summary>
    public RenderSurfaceHandle surface { get; }

    /// <summary>
    /// Gets whether this pass clears its presentation target before drawing.
    /// </summary>
    public bool clearsPresentationTarget { get; }

    /// <summary>
    /// Gets the linear clear color for a presentation target.
    /// </summary>
    public RenderClearColor presentationClearColor { get; }

    /// <summary>
    /// Gets backend-ready view transforms, or <see langword="null"/> for a matrix-free pass.
    /// </summary>
    public RenderViewTransform? viewTransform { get; }

    /// <summary>
    /// Gets whether callback recording is serial or worker-thread eligible.
    /// </summary>
...
{
    /// <summary>
    /// Begins execution and prepares transient allocations.
    /// </summary>
    /// <param name="graph">
    ...
    /// <summary>
    /// Begins one scheduled pass and acquires its command encoder.
    /// </summary>
    /// <param name="pass">
    /// Scheduled pass metadata.
    /// </param>
    /// <returns>
    /// A command encoder scoped to this pass.
    /// </returns>
    RenderCommandEncoder BeginPass(CompiledRenderPass pass);

    /// <summary>
    /// Ends one scheduled pass and releases its encoder.
    /// </summary>
    /// <param name="pass">
    /// Scheduled pass metadata.
    /// </param>
    ...
    /// <summary>
    /// Ends graph execution without presenting an additional frame.
    /// </summary>
    /// <param name="graph">
    /// Compiled graph that finished or failed.
    /// </param>
...
public sealed class CompiledRenderGraph
{
        ...
        IReadOnlyList<CompiledRenderBuffer> buffers)
    {
        ...
        m_buffers = Array.AsReadOnly(buffers.ToArray());
    }

    /// <summary>
    /// Gets the source frame generation.
    /// </summary>
    public uint generation { get; }

    /// <summary>
    /// Gets scheduled passes in backend view order.
    /// </summary>
    public IReadOnlyList<CompiledRenderPass> passes => m_passes;

    /// <summary>
    /// Gets compiled logical texture allocations.
    /// </summary>
    public IReadOnlyList<CompiledRenderTexture> textures => m_textures;

    /// <summary>
    /// Gets compiled logical buffer allocations.
    /// </summary>
    ...
    /// </summary>
    /// <param name="backend">
    /// Backend bridge for the current device generation.
    /// </param>
    /// <param name="frameIndex">
    /// Monotonic frame index exposed to pass callbacks.
    /// </param>
...
public sealed class RenderGraphCompileResult
{
    ...
    /// <summary>
    /// Gets the executable graph, or <see langword="null"/> when compilation failed.
    /// </summary>
    public CompiledRenderGraph? graph { get; }

    /// <summary>
    /// Gets deterministic compilation diagnostics.
    /// </summary>
    public IReadOnlyList<RenderGraphDiagnostic> diagnostics => m_diagnostics;

    /// <summary>
    /// Gets passes removed because they did not contribute to an output or side effect.
    /// </summary>
    public int culledPassCount { get; }

    /// <summary>
    /// Gets whether an executable graph was produced.
    /// </summary>
