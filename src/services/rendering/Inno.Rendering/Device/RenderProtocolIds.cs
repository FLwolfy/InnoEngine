...
{
    /// <summary>
    /// Creates an open semantic resource identifier.
    /// </summary>
    /// <param name="value">
    /// Globally stable resource protocol value.
    /// </param>
    ...
    /// <summary>
    /// Gets whether the identifier contains a protocol value.
    /// </summary>
...
{
    /// <summary>
    /// Creates an open frame-data channel identifier.
    /// </summary>
    /// <param name="value">
    /// Globally stable channel protocol value.
    /// </param>
