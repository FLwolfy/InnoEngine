...
/// <summary>Configures one source-function library through the standard asset import-settings sidecar.</summary>
...
public sealed class ShaderSourceImportSettings : ISerializable
{
    ...
    /// <summary>Gets or sets the explicitly exported function names. Unlisted helpers remain private to the source library.</summary>
    ...
    /// <summary>Gets or sets the slash-delimited authoring catalog path used to group this library in creation UIs.</summary>
    [SerializableProperty] public string catalogPath { get; set; } = string.Empty;
    /// <summary>Gets or sets the stable ordering value of this library inside its authoring catalog group.</summary>
