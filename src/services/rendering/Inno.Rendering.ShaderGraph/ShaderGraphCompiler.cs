...
{
    /// <summary>
    /// Creates a shader graph compilation result.
    /// </summary>
    /// <param name="module">
    /// Generated shared Shader IR, or <see langword="null"/> after failure.
    /// </param>
    /// <param name="diagnostics">
    /// Structured graph and source diagnostics.
    /// </param>
    ...
    /// <summary>
    /// Gets generated shared Shader IR, or <see langword="null"/> after failure.
    /// </summary>
    public ShaderIRModule? module { get; }

    /// <summary>
    /// Gets graph and source diagnostics.
    /// </summary>
    public IReadOnlyList<ShaderDiagnostic> diagnostics { get; }

    /// <summary>
    /// Gets whether a complete valid IR module was generated.
    /// </summary>
...
/// <summary>
/// Compiles Plugin-defined shader nodes into the same IR used by handwritten shaders.
/// </summary>
public static class ShaderGraphCompiler
{
    /// <summary>
    /// Compiles one imported shader graph asset into shared Shader IR.
    /// </summary>
    /// <param name="asset">
    /// Imported graph asset.
    /// </param>
    /// <param name="registry">
    /// Active Plugin node generation.
    /// </param>
    /// <param name="serialization">
    /// The serialization registry used to decode node properties during compilation.
    /// </param>
    /// <returns>
    /// Generated IR or node-mapped diagnostics.
    /// </returns>
    ...
    /// <summary>
    /// Compiles one neutral graph through its Plugin-provided program output node.
    /// </summary>
    /// <param name="assetPath">
    /// Canonical asset path used by diagnostics.
    /// </param>
    /// <param name="shaderName">
    /// Artist-facing generated shader name.
    /// </param>
    /// <param name="document">
    ...
    /// </param>
    /// <returns>
    /// Generated shared IR or structured diagnostics.
    /// </returns>
    public static ShaderGraphCompileResult Compile(
        string assetPath,
        string shaderName,
    ...
    private static ShaderGraphCompileResult Failure(string code, string message)
        => new(null, [new ShaderDiagnostic(code, DiagnosticSeverity.Error, message)]);
}
