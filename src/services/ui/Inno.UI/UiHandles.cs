...
{
    /// <summary>Gets whether this handle identifies a live context candidate.</summary>
...
{
    /// <summary>Gets whether this handle identifies a live document candidate.</summary>
    public bool isValid => value != 0;
}
