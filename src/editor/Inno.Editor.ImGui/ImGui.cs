...
{
    /// <summary>Draws unformatted text.</summary>
    /// <param name="text">The text to draw.</param>
    public static void Text(string text) => RawImGui.TextUnformatted(text);

    /// <summary>Draws a standard button.</summary>
    /// <param name="label">The visible label and optional ImGui identity suffix.</param>
    /// <param name="size">The requested size, or zero components for automatic sizing.</param>
    /// <returns><see langword="true"/> when the button is activated.</returns>
    public static bool Button(string label, Vector2 size = default) => RawImGui.Button(label, size);

    /// <summary>Draws a compact button.</summary>
    /// <param name="label">The visible label and optional ImGui identity suffix.</param>
    /// <returns><see langword="true"/> when the button is activated.</returns>
    public static bool SmallButton(string label) => RawImGui.SmallButton(label);

    /// <summary>Draws and edits a Boolean value.</summary>
    /// <param name="label">The control label.</param>
    /// <param name="value">The value to display and update.</param>
    ...
    /// <summary>Draws and edits a bounded UTF-8 text value.</summary>
    /// <param name="label">The control label.</param>
    ...
    /// <summary>Draws and edits an integer value.</summary>
    /// <param name="label">The control label.</param>
    /// <param name="value">The value to display and update.</param>
    /// <returns><see langword="true"/> when the value changes.</returns>
    public static bool InputInt(string label, ref int value) => RawImGui.InputInt(label, ref value);

    /// <summary>Draws and edits a floating-point value.</summary>
    /// <param name="label">The control label.</param>
    /// <param name="value">The value to display and update.</param>
    /// <returns><see langword="true"/> when the value changes.</returns>
    public static bool InputFloat(string label, ref float value) => RawImGui.InputFloat(label, ref value);

    /// <summary>Draws a floating-point drag control.</summary>
    /// <param name="label">The control label.</param>
    /// <param name="value">The value to display and update.</param>
    /// <param name="speed">The drag speed.</param>
    /// <param name="minimum">The inclusive minimum, or zero with a zero maximum for no clamping.</param>
    /// <param name="maximum">The inclusive maximum, or zero with a zero minimum for no clamping.</param>
    /// <returns><see langword="true"/> when the value changes.</returns>
    ...
    /// <summary>Draws and edits a four-component color.</summary>
    /// <param name="label">The control label.</param>
    /// <param name="value">The RGBA value to display and update.</param>
    /// <param name="flags">Color editing behavior.</param>
    /// <returns><see langword="true"/> when the value changes.</returns>
    ...
    /// <summary>Begins a child region.</summary>
    /// <param name="id">The child identity.</param>
    /// <param name="size">The requested child size.</param>
    /// <param name="flags">Child-region behavior.</param>
    /// <returns><see langword="true"/> when child contents should be submitted.</returns>
    ...
    /// <param name="id">The table identity.</param>
    /// <param name="columns">The positive column count.</param>
    /// <param name="flags">Table behavior.</param>
    /// <param name="size">The requested outer size.</param>
    /// <returns><see langword="true"/> when table contents should be submitted.</returns>
    ...
    /// <summary>Ends the current table.</summary>
    public static void EndTable() => RawImGui.EndTable();

    /// <summary>Declares one table column.</summary>
    /// <param name="label">The column label.</param>
    /// <param name="flags">Column behavior.</param>
    /// <param name="widthOrWeight">The initial fixed width or stretch weight.</param>
    ...
    /// <summary>Draws the table header row from configured column labels.</summary>
    public static void TableHeadersRow() => RawImGui.TableHeadersRow();

    /// <summary>Advances to the next table row.</summary>
    public static void TableNextRow() => RawImGui.TableNextRow();

    /// <summary>Advances to the next table column.</summary>
    /// <returns><see langword="true"/> when the column is visible.</returns>
    public static bool TableNextColumn() => RawImGui.TableNextColumn();

    /// <summary>Begins a combo popup.</summary>
    /// <param name="label">The control label.</param>
    /// <param name="preview">The preview text.</param>
    /// <param name="flags">Combo behavior.</param>
    /// <returns><see langword="true"/> when combo contents should be submitted.</returns>
    ...
    /// <summary>Ends the current combo popup.</summary>
    public static void EndCombo() => RawImGui.EndCombo();

    /// <summary>Draws one selectable item.</summary>
    /// <param name="label">The visible label and identity.</param>
    /// <param name="selected">Whether the item is currently selected.</param>
    /// <param name="flags">Selectable behavior.</param>
    /// <returns><see langword="true"/> when the item is activated.</returns>
    ...
    /// <summary>Draws a collapsible section header.</summary>
    /// <param name="label">The visible label and identity.</param>
    /// <param name="flags">Tree-node behavior.</param>
    /// <returns><see langword="true"/> when the section is open.</returns>
    public static bool CollapsingHeader(
        string label,
        ImGuiTreeNodeFlags flags = ImGuiTreeNodeFlags.None)
        => RawImGui.CollapsingHeader(label, flags);

    /// <summary>Draws a tree node and pushes its tree scope when it is open.</summary>
    /// <param name="label">The visible label and identity.</param>
    /// <param name="flags">Tree-node behavior.</param>
    /// <returns><see langword="true"/> when child contents should be submitted.</returns>
    ...
    /// <summary>Ends the current open tree-node scope.</summary>
    public static void TreePop() => RawImGui.TreePop();

    /// <summary>Begins a tab bar.</summary>
    /// <param name="id">The tab bar identity.</param>
    /// <param name="flags">Tab-bar behavior.</param>
    ...
    /// <summary>Ends the current tab bar.</summary>
    public static void EndTabBar() => RawImGui.EndTabBar();

    /// <summary>Begins one tab item.</summary>
    ...
    /// <summary>Ends the current tab item.</summary>
    public static void EndTabItem() => RawImGui.EndTabItem();

    /// <summary>Opens a named popup.</summary>
    /// <param name="id">The popup identity.</param>
    /// <param name="flags">Popup opening behavior.</param>
    public static void OpenPopup(string id, ImGuiPopupFlags flags = ImGuiPopupFlags.None)
        => RawImGui.OpenPopup(id, flags);

    /// <summary>Begins a named popup.</summary>
    /// <param name="id">The popup identity.</param>
    /// <param name="flags">Popup window behavior.</param>
    /// <returns><see langword="true"/> when popup contents should be submitted.</returns>
    public static bool BeginPopup(string id, ImGuiWindowFlags flags = ImGuiWindowFlags.None)
        => RawImGui.BeginPopup(id, flags);

    /// <summary>Ends the current popup.</summary>
    ...
    /// <param name="disabled">Whether controls in the block are disabled.</param>
    public static void BeginDisabled(bool disabled = true) => RawImGui.BeginDisabled(disabled);

    /// <summary>Ends the current disabled block.</summary>
    public static void EndDisabled() => RawImGui.EndDisabled();

    /// <summary>Begins an item group.</summary>
    public static void BeginGroup() => RawImGui.BeginGroup();

    /// <summary>Ends the current item group.</summary>
    public static void EndGroup() => RawImGui.EndGroup();

    /// <summary>Pushes a string identity onto the ImGui ID stack.</summary>
    /// <param name="id">The identity segment.</param>
    public static void PushId(string id) => RawImGui.PushID(id);

    /// <summary>Pushes an integer identity onto the ImGui ID stack.</summary>
    /// <param name="id">The identity segment.</param>
    public static void PushId(int id) => RawImGui.PushID(id);

    /// <summary>Pops one identity from the ImGui ID stack.</summary>
    public static void PopId() => RawImGui.PopID();

    /// <summary>Pushes one color override.</summary>
    /// <param name="color">The style color slot.</param>
    /// <param name="value">The linear RGBA value.</param>
    public static void PushStyleColor(ImGuiCol color, Vector4 value)
        => RawImGui.PushStyleColor(color, value);

    /// <summary>Pops color overrides.</summary>
    /// <param name="count">The positive number of overrides to pop.</param>
    public static void PopStyleColor(int count = 1) => RawImGui.PopStyleColor(count);

    /// <summary>Pushes one scalar style override.</summary>
    ...
    /// <summary>Pushes one two-component style override.</summary>
    /// <param name="style">The style variable.</param>
    /// <param name="value">The vector value.</param>
    public static void PushStyleVar(ImGuiStyleVar style, Vector2 value)
        => RawImGui.PushStyleVar(style, value);

    /// <summary>Pops style-variable overrides.</summary>
    /// <param name="count">The positive number of overrides to pop.</param>
    public static void PopStyleVar(int count = 1) => RawImGui.PopStyleVar(count);

    /// <summary>Places the next item on the same line.</summary>
    /// <param name="offset">The horizontal offset from the line start, or zero for automatic placement.</param>
    /// <param name="spacing">The explicit spacing, or a negative value for the current style spacing.</param>
    ...
    /// <summary>Draws a labeled horizontal separator.</summary>
    /// <param name="label">The separator label.</param>
    public static void SeparatorText(string label) => RawImGui.SeparatorText(label);

    /// <summary>Adds one standard vertical spacing unit.</summary>
    public static void Spacing() => RawImGui.Spacing();

    /// <summary>Advances layout by an invisible size.</summary>
    /// <param name="size">The horizontal and vertical layout extent.</param>
    public static void Dummy(Vector2 size) => RawImGui.Dummy(size);

    /// <summary>Sets the width of the next item.</summary>
    /// <param name="width">The requested width; negative values align relative to the right edge.</param>
    public static void SetNextItemWidth(float width) => RawImGui.SetNextItemWidth(width);

    /// <summary>Gets the remaining content size in the current region.</summary>
    /// <returns>The remaining local width and height.</returns>
    public static Vector2 GetContentRegionAvailable() => RawImGui.GetContentRegionAvail();

    /// <summary>Gets the current local cursor position.</summary>
    /// <returns>The local cursor position.</returns>
    public static Vector2 GetCursorPosition() => RawImGui.GetCursorPos();

    /// <summary>Sets the current local cursor position.</summary>
    /// <param name="position">The local cursor position.</param>
    public static void SetCursorPosition(Vector2 position) => RawImGui.SetCursorPos(position);

    /// <summary>Gets the current screen-space cursor position.</summary>
    /// <returns>The screen-space cursor position.</returns>
    public static Vector2 GetCursorScreenPosition() => RawImGui.GetCursorScreenPos();

    /// <summary>Gets the minimum screen-space corner of the previous item.</summary>
    /// <returns>The item minimum corner.</returns>
    public static Vector2 GetItemMinimum() => RawImGui.GetItemRectMin();

    /// <summary>Gets the maximum screen-space corner of the previous item.</summary>
    /// <returns>The item maximum corner.</returns>
    public static Vector2 GetItemMaximum() => RawImGui.GetItemRectMax();

    /// <summary>Measures text using the current font.</summary>
    /// <param name="text">The text to measure.</param>
    /// <returns>The measured width and height.</returns>
    public static Vector2 MeasureText(string text) => RawImGui.CalcTextSize(text);

    /// <summary>Gets whether the previous item is hovered.</summary>
    /// <param name="flags">Hovered query behavior.</param>
    ...
    /// <summary>Gets whether the previous item is active.</summary>
    /// <returns><see langword="true"/> while the item owns an active interaction.</returns>
    public static bool IsItemActive() => RawImGui.IsItemActive();

    /// <summary>Gets whether the previous item was clicked with a mouse button.</summary>
    /// <param name="button">The mouse button to query.</param>
    /// <returns><see langword="true"/> when the item was clicked.</returns>
    public static bool IsItemClicked(ImGuiMouseButton button = ImGuiMouseButton.Left)
        => RawImGui.IsItemClicked(button);

    /// <summary>Converts a floating-point RGBA color to Dear ImGui packed color order.</summary>
    ...
    /// <summary>Adds a line to the current window draw list.</summary>
    /// <param name="start">The screen-space start point.</param>
    /// <param name="end">The screen-space end point.</param>
    /// <param name="color">The packed ImGui color.</param>
    ...
    /// <summary>Adds a rectangle outline to the current window draw list.</summary>
    /// <param name="minimum">The screen-space minimum corner.</param>
    /// <param name="maximum">The screen-space maximum corner.</param>
    /// <param name="color">The packed ImGui color.</param>
    /// <param name="rounding">The corner rounding radius.</param>
    ...
    /// <summary>Adds a filled rectangle to the current window draw list.</summary>
    /// <param name="minimum">The screen-space minimum corner.</param>
    /// <param name="maximum">The screen-space maximum corner.</param>
    /// <param name="color">The packed ImGui color.</param>
    /// <param name="rounding">The corner rounding radius.</param>
    ...
    /// <summary>Adds text to the current window draw list.</summary>
    /// <param name="position">The screen-space text origin.</param>
    /// <param name="color">The packed ImGui color.</param>
    /// <param name="text">The text to draw.</param>
