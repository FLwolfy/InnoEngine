...
/// </summary>
/// <param name="drawerType">The concrete drawer type selected from the active type catalog.</param>
/// <returns>A new drawer instance whose runtime type is <paramref name="drawerType"/>.</returns>
