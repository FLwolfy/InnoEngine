...
public interface IInspectionPropertyEditService
{
    ...
    /// </summary>
    /// <param name="owner">The domain object that owns the root serialized property.</param>
    /// <param name="propertyName">The exact root serialized member name.</param>
    /// <param name="mutation">The callback that assigns the requested value.</param>
    /// <param name="historyName">The user-facing name for the resulting history entry.</param>
    /// <returns>
