...
/// <summary>Describes an imported C# source snapshot and its parse diagnostics.</summary>
[StableTypeId("10de711f-c33e-4ae2-a2e3-df285a86e976")]
public sealed class ScriptSourceAsset : AssetObject
{
    /// <summary>Gets the default assembly scope inferred for the source.</summary>
    ...
    /// <summary>Gets parse diagnostics associated with the source snapshot.</summary>
    [SerializableProperty]
    public string[] parseDiagnostics { get; private set; } = [];

    /// <summary>Creates an empty script source asset for deserialization.</summary>
