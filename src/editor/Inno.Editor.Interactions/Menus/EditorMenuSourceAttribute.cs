...
/// <summary>
/// Registers a dynamic editor menu source.
/// </summary>
...
public sealed class EditorMenuSourceAttribute : Attribute
{
    ...
    /// </summary>
    /// <param name="area">
    /// The exact menu area that receives placements from the source.
    /// </param>
    /// <param name="priority">
    /// The ordering priority used when multiple dynamic sources contribute to the surface.
    /// </param>
    ...
    /// <summary>
    /// Gets the contributed menu area.
    /// </summary>
    public string area { get; }

    /// <summary>
    /// Gets the provider ordering priority.
    /// </summary>
