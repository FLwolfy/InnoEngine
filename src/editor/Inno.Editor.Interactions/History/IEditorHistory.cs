...
{
    /// <summary>
    /// Gets whether an Undo transition is currently available.
    /// </summary>
    bool canUndo { get; }

    /// <summary>
    /// Gets whether a Redo transition is currently available.
    /// </summary>
    bool canRedo { get; }
    ...
    /// <summary>
    /// Gets the next Undo operation name, or <see langword="null"/>.
    /// </summary>
    string? undoName { get; }

    /// <summary>
    /// Gets the next Redo operation name, or <see langword="null"/>.
    /// </summary>
    string? redoName { get; }

    /// <summary>
    /// Gets why the next Undo entry is unavailable, or <see langword="null"/>.
    /// </summary>
    string? undoUnavailableReason { get; }

    /// <summary>
    /// Gets why the next Redo entry is unavailable, or <see langword="null"/>.
    /// </summary>
    string? redoUnavailableReason { get; }

    /// <summary>
    /// Gets the diagnostic that faulted this history, or <see langword="null"/>.
    /// </summary>
    string? faultReason { get; }

    /// <summary>
    /// Gets the resident payload bytes retained by committed entries.
    /// </summary>
    long residentBytes { get; }

    /// <summary>
    /// Gets the temporary disk payload bytes retained by committed entries.
    /// </summary>
    long diskBytes { get; }

    /// <summary>
    /// Begins an atomic group of neutral history operations.
    /// </summary>
    /// <param name="name">
    /// The user-facing grouped operation name.
    /// </param>
    /// <returns>
    ...
    /// <summary>
    /// Applies and records a neutral change through its current-generation handler.
    /// </summary>
    /// <param name="name">
    ...
    /// </summary>
    /// <returns>
    /// The transition result. A state-preserving failure remains available for retry.
    /// </returns>
