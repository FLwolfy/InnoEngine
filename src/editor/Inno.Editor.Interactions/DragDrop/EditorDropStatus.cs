...
/// <summary>
/// Describes whether and how a target accepts the active drag.
/// </summary>
public readonly record struct EditorDropStatus
{
    ...
    /// </summary>
    /// <param name="canDrop">
    /// Whether the active source may be delivered to the target.
    /// </param>
    /// <param name="visual">
    ...
    /// <summary>
    /// Gets whether the active source may be dropped.
    /// </summary>
    public bool canDrop { get; }

    /// <summary>
    /// Gets the standard target visual.
    /// </summary>
    public EditorDropVisual visual { get; }

    /// <summary>
    /// Gets an incompatible drop status.
    /// </summary>
    ...
    /// </summary>
    /// <param name="visual">
    /// The standard visual drawn while the compatible source hovers the target.
    /// </param>
    /// <returns>
