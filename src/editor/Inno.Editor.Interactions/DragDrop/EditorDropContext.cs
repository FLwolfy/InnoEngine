...
public sealed class EditorDropContext
{
    ...
    /// Thrown when <paramref name="editor"/>, <paramref name="interactions"/>, <paramref name="data"/>, or <paramref name="target"/> is <see langword="null"/>.
    /// </exception>
