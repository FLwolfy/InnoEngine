...
/// <summary>
/// Provides contextual state while beginning an editor drag.
/// </summary>
public sealed class EditorDragContext
{
    /// <summary>
    /// Creates a managed editor drag request.
    /// </summary>
    /// <param name="editor">
    ...
    /// </param>
    /// <param name="area">
    /// The interaction area that produced the source.
    /// </param>
    /// <param name="data">
    /// The managed source object, label, and validity predicate.
    /// </param>
    /// <exception cref="ArgumentNullException">
    /// Thrown when <paramref name="editor"/>, <paramref name="interactions"/>, or <paramref name="data"/> is <see langword="null"/>.
    /// </exception>
    ...
    /// <summary>
    /// Gets the source interaction area.
    /// </summary>
    public string area { get; }

    /// <summary>
    /// Gets the managed drag data.
    /// </summary>
