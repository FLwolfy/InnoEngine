...
/// <summary>
/// Contains the managed source object and label for one editor drag operation.
/// </summary>
public sealed class EditorDragData
{
    ...
    /// </summary>
    /// <param name="source">
    /// The managed object exposed to typed drop handlers.
    /// </param>
    /// <param name="label">
    /// The human-readable label used by drag previews.
    /// </param>
    /// <param name="isValid">
    /// An optional predicate evaluated while dragging to reject stale source objects.
    /// </param>
    ...
    /// <summary>
    /// Gets whether the source remains valid for the current drag session.
    /// </summary>
