...
/// <summary>
/// Identifies a component together with its owning game object.
/// </summary>
internal sealed class ComponentEditorTarget
{
    /// <summary>
    /// Creates an inspector action target that keeps a component paired with its owning game object.
    /// </summary>
    /// <param name="gameObject">
    /// The live game object that owns the component.
    /// </param>
    /// <param name="component">
    /// The component operated on by the inspector action.
    /// </param>
