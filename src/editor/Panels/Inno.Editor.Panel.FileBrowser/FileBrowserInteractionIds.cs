...
internal static class FileBrowserInteractionIds
{
    ...
    internal const string C_CREATE_PLUGIN_DEFINITION = "file-browser/create-plugin-definition";
    internal const string C_DELETE = "file-browser/delete";
    internal const string C_EXPORT_PLUGIN = "file-browser/export-plugin";
