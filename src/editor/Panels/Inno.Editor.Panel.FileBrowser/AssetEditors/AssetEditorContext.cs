...
public sealed class AssetEditorContext
{
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="editorContext"/>, <paramref name="interactions"/>, <paramref name="relativePath"/>, or <paramref name="name"/> is <see langword="null"/>.</exception>
