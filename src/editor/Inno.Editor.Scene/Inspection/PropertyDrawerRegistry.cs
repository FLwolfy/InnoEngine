...
internal sealed class PropertyDrawerRegistry : IDisposable
{
    ...
    internal PropertyDrawerRegistry(EditorSceneWorkspace workspace)
    {
        m_registry = new PropertyTypeRegistry(workspace);
    }
    ...
    private sealed class PropertyTypeRegistry : TypeRegistry<Registration[]>
    {
        ...
        internal PropertyTypeRegistry(EditorSceneWorkspace workspace)
        {
    ...
    private static IPropertyDrawer CreateDrawer(Type type, EditorSceneWorkspace workspace)
    {
        ...
        object?[] arguments = parameters.Length switch
        {
            ...
            _ => throw new InvalidOperationException(
                $"Property drawer '{type.FullName}' may only depend on EditorSceneWorkspace.")
        };
