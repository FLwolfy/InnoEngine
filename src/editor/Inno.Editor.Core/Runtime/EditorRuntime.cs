...
public abstract class EditorRuntime : IDisposable
{
    ...
    /// </summary>
    /// <param name="context">The shared editor context.</param>
    ...
    /// <summary>Starts the runtime and activates its initial extension generation.</summary>
    public abstract void Start();

    /// <summary>Updates the runtime for one editor frame.</summary>
