...
public sealed class EditorProjectSettings
{
    ...
    /// </exception>
    public EditorProjectSettings(string projectDirectory)
    {
    ...
    /// </returns>
    public IReadOnlyList<string> GetSectionNames(string prefix = "")
    {
    ...
    /// </param>
    public void SetImGuiLayout(string? layout)
    {
