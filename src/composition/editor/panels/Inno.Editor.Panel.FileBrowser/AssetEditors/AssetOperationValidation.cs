...
/// <summary>
/// Describes whether an editor asset operation may proceed.
/// </summary>
public readonly record struct AssetOperationValidation
{
    ...
    /// </summary>
    /// <param name="isValid">
    /// Whether the requested asset operation may proceed.
    /// </param>
    /// <param name="message">
    ...
    /// <summary>
    /// Gets whether the operation may proceed.
    /// </summary>
    public bool isValid { get; }

    /// <summary>
    /// Gets the validation diagnostic.
    /// </summary>
    ...
    /// </summary>
    /// <param name="message">
    /// The user-facing diagnostic explaining why the operation was rejected.
    /// </param>
    /// <returns>
