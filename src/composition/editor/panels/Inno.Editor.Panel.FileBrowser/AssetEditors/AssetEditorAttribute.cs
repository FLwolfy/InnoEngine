...
/// <summary>
/// Associates an asset editor with an imported asset type.
/// </summary>
...
public sealed class AssetEditorAttribute : Attribute
{
    ...
    /// The imported asset type handled by the editor.
    /// </param>
    /// <param name="useForChildren">
    /// Whether the editor may also handle assignable derived asset types.
    /// </param>
    /// <param name="priority">
    ...
    /// <summary>
    /// Gets the imported asset type handled by the editor.
    /// </summary>
    public Type assetType { get; }

    /// <summary>
    /// Gets whether derived asset types are accepted.
    /// </summary>
