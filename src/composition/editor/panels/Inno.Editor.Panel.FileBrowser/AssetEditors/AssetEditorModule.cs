...
public sealed partial class AssetEditorModule : EditorModule, IInspectionIconProvider<AssetFileEntry>
{
    ...
    internal string folderIcon => m_settings
        ...
        .GetAsString("value", Inno.Adapter.Presentation.ImGui.ImGuiIcon.Folder)!;
    ...
    public string GetIcon(AssetFileEntry entry)
    {
        ...
        return m_settings
            ...
            .GetAsString("value", Inno.Adapter.Presentation.ImGui.ImGuiIcon.File)!;
    }
