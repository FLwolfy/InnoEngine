...
/// <summary>
/// Identifies a system together with its owning scene.
/// </summary>
internal sealed class SystemEditorTarget
{
    /// <summary>
    /// Creates an inspector action target that keeps a system paired with its owning scene.
    /// </summary>
    /// <param name="scene">
    /// The loaded scene that owns the system.
    /// </param>
    /// <param name="system">
    /// The system operated on by the inspector action.
    /// </param>
