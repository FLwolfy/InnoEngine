...
{
    /// <summary>Gets the comfortable default density.</summary>
    public override EditorSettingObject defaultValue => CreateDefault();

    /// <summary>Gets the appearance section containing this setting.</summary>
    public override string section => "Layout";

    /// <summary>Gets the user-facing density description.</summary>
    public override string description
        => "Use comfortable spacing by default, or fit more controls with compact density.";

    /// <summary>Draws the density selector.</summary>
    /// <param name="setting">The mutable editor setting value.</param>
