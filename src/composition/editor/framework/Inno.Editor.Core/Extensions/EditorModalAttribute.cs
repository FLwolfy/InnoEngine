...
/// <summary>
/// Registers a centered editor modal for automatic discovery.
/// </summary>
...
public sealed class EditorModalAttribute : Attribute
{
    ...
    /// </summary>
    /// <param name="id">
    /// The stable identity used to retain modal transition state across refreshes.
    /// </param>
    /// <param name="title">
    /// The visible title rendered by the modal host.
    /// </param>
    /// <param name="order">
    /// The stable ordering value when multiple modals are visible.
    /// </param>
