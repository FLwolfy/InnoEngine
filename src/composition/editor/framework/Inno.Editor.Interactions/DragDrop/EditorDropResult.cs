...
/// <summary>
/// Describes the observable result of a completed editor drop.
/// </summary>
public readonly record struct EditorDropResult
{
    ...
    /// </summary>
    /// <param name="accepted">
    /// Whether the handler accepted and completed the drop.
    /// </param>
    /// <param name="selectionTarget">
    /// An optional object that the originating view should select.
    /// </param>
    /// <param name="revealTarget">
    /// An optional object that the originating view should reveal or expand.
    /// </param>
    ...
    /// <summary>
    /// Gets whether the drop was accepted.
    /// </summary>
    public bool accepted { get; }

    /// <summary>
    /// Gets the optional target that should become selected.
    /// </summary>
    public object? selectionTarget { get; }

    /// <summary>
    /// Gets the optional hierarchy target that should be revealed.
    /// </summary>
    public object? revealTarget { get; }

    /// <summary>
    /// Gets a rejected drop result.
    /// </summary>
