...
/// <summary>
/// Provides contextual state while constructing an editor menu.
/// </summary>
public sealed class EditorMenuContext
{
    /// <summary>
    /// Creates a contextual menu request.
    /// </summary>
    /// <param name="editor">
    ...
    /// </param>
    /// <param name="area">
    /// The exact menu area being requested.
    /// </param>
    /// <param name="target">
    /// The optional object the menu operates on.
    /// </param>
    ...
    /// <summary>
    /// Gets the requested menu area.
    /// </summary>
    public string area { get; }

    /// <summary>
    /// Gets the contextual menu target.
    /// </summary>
