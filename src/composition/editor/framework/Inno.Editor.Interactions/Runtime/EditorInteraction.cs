...
public readonly struct EditorInteraction
{
    ...
    /// <summary>
    /// Gets the optional target represented by this handle.
    /// </summary>
    public object? target { get; }

    /// <summary>
    /// Gets whether this handle's target is the current editor selection.
    /// </summary>
    public bool isSelected => target is not null &&
                              Equals(m_interactions.selection.selectedTarget, target);

    /// <summary>
    /// Marks this area and target as the active keyboard context.
    /// </summary>
    public void Focus() => m_interactions.Focus(area, target);

    /// <summary>
    /// Selects this target, or clears selection when the target is <see langword="null"/>.
    /// </summary>
    /// <returns>
    /// <see langword="true"/> when the built-in selection action executed; otherwise, <see langword="false"/>.
    /// </returns>
    public bool Select()
    ...
    /// <summary>
    /// Queries an action for this area and target.
    /// </summary>
    /// <param name="action">
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> when a visible and enabled action executed; otherwise, <see langword="false"/>.
    /// </returns>
    /// <exception cref="ArgumentException">
    /// Thrown when <paramref name="action"/> is empty.
    /// </exception>
    ...
    /// </param>
    /// <param name="argument">
    /// Optional presentation data supplied by the current view.
    /// </param>
    /// <returns>
    /// <see langword="true"/> when the action presented content; otherwise, <see langword="false"/>.
    /// </returns>
    /// <exception cref="ArgumentException">
    /// Thrown when <paramref name="action"/> is empty.
    /// </exception>
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> when the action is active for this exact target; otherwise, <see langword="false"/>.
    /// </returns>
    /// <exception cref="ArgumentException">
    /// Thrown when <paramref name="action"/> is empty.
    /// </exception>
    ...
    /// </summary>
    /// <returns>
    /// The immutable resolved menu model.
    /// </returns>
    public EditorMenuModel BuildMenu() => m_interactions.BuildMenu(area, target);

    /// <summary>
    /// Builds the complete compact toolbar for this area and target.
    /// </summary>
    /// <returns>
    /// The immutable resolved toolbar model.
    /// </returns>
    public EditorToolbarModel BuildToolbar() => m_interactions.BuildToolbar(area, target);

    /// <summary>
    /// Resolves the shortcut displayed for an action in this area.
    /// </summary>
    /// <param name="action">
    /// The stable action name.
    /// </param>
    /// <param name="gesture">
    /// The resolved gesture when successful.
    /// </param>
    /// <returns>
    /// <see langword="true"/> when a compatible shortcut exists; otherwise, <see langword="false"/>.
    /// </returns>
    /// <exception cref="ArgumentException">
    /// Thrown when <paramref name="action"/> is empty.
    /// </exception>
    ...
    /// <summary>
    /// Gets the currently active drag identity, if its source remains registered.
    /// </summary>
    /// <param name="identity">
    /// The active domain-qualified runtime identity when available.
    /// </param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="identity">
    /// The active domain-qualified runtime identity.
    /// </param>
    /// <param name="placement">
    /// The requested placement relative to the target.
    /// </param>
    /// <returns>
    /// The drop compatibility and visual state.
    /// </returns>
    ...
    /// <summary>
    /// Delivers a managed drop to this target.
    /// </summary>
    /// <param name="identity">
    /// The active domain-qualified runtime identity.
    /// </param>
