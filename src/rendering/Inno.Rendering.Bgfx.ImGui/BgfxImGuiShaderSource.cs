...
/// <summary>
/// Provides shaderc-compatible sources for the built-in BGFX ImGui pipeline.
/// </summary>
public static class BgfxImGuiShaderSource
{
    /// <summary>
    /// Gets the vertex and fragment interface definition.
    /// </summary>
    ...
    /// <summary>
    /// Gets the shaderc-compatible ImGui vertex stage.
    /// </summary>
    ...
    /// <summary>
    /// Gets the shaderc-compatible alpha-blended ImGui fragment stage.
    /// </summary>
