...
{
    /// <summary>
    /// Informational compiler context.
    /// </summary>
    Info,
    /// <summary>
    /// A recoverable issue that does not invalidate the artifact.
    /// </summary>
    Warning,
    /// <summary>
    /// An issue that invalidates the candidate artifact.
    /// </summary>
    Error
}
...
public sealed class ShaderIRPass
{
    ...
    /// <summary>
    /// Gets the pass interface and fixed-function state.
    /// </summary>
...
public sealed class ShaderIRModule
{
    ...
    /// <summary>
    /// Gets stable properties, keywords and pass declarations.
    /// </summary>
