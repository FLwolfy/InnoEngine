...
public readonly record struct RenderBindingId
{
    ...
    /// <summary>
    /// Gets whether the identifier contains a stable manifest name.
    /// </summary>
...
public readonly record struct GraphicsPipelineHandle
{
    ...
    /// <summary>
    /// Gets whether the handle identifies a graphics pipeline.
    /// </summary>
...
public readonly record struct ComputePipelineHandle
{
    ...
    /// <summary>
    /// Gets whether the handle identifies a compute pipeline.
    /// </summary>
    public bool isValid => value != 0 && deviceGeneration != 0;
}

/// <summary>
/// Describes one texture subresource box for copy and blit commands.
/// </summary>
public readonly record struct RenderTextureRegion
{
    /// <summary>
    /// Creates a texture subresource box.
    /// </summary>
    /// <param name="mip">
    ...
    /// </param>
    /// <param name="layer">
    /// Array layer or depth-slice origin.
    /// </param>
    /// <param name="width">
    /// Positive texel width.
    /// </param>
    /// <param name="height">
    /// Positive texel height.
    /// </param>
    /// <param name="depth">
    ...
    /// <summary>
    /// Gets the horizontal texel origin.
    /// </summary>
    public int x { get; }

    /// <summary>
    /// Gets the vertical texel origin.
    /// </summary>
    public int y { get; }

    /// <summary>
    /// Gets the array layer or depth-slice origin.
    /// </summary>
    public int layer { get; }

    /// <summary>
    /// Gets the texel width.
    /// </summary>
    public int width { get; }

    /// <summary>
    /// Gets the texel height.
    /// </summary>
    public int height { get; }

    /// <summary>
    /// Gets the layer or depth-slice count.
    /// </summary>
...
public abstract class RenderCommandEncoder
{
    ...
    /// <summary>
    /// Binds a graph texture to a shader interface slot.
    /// </summary>
    /// <param name="binding">
    /// Stable shader binding identifier.
    /// </param>
    /// <param name="texture">
    ...
    /// <summary>
    /// Binds a graph texture and explicit sampler state.
    /// </summary>
    /// <param name="binding">
    /// Stable shader binding identifier.
    /// </param>
    ...
    /// <summary>
    /// Binds a persistent texture and explicit sampler state.
    /// </summary>
    /// <param name="binding">
    /// Stable shader binding identifier.
    /// </param>
    ...
    /// </summary>
    /// <param name="binding">
    /// Stable storage-image binding identifier.
    /// </param>
    /// <param name="texture">
    /// Graph texture created with storage usage.
    /// </param>
    /// <param name="mipLevel">
    /// Mip level exposed to the shader.
    /// </param>
    ...
    /// </param>
    /// <param name="texture">
    /// Persistent texture created with storage usage.
    /// </param>
    /// <param name="mipLevel">
    /// Mip level exposed to the shader.
    /// </param>
    ...
    /// <summary>
    /// Uploads one uniform value using manifest-validated bytes.
    /// </summary>
    /// <param name="binding">
    /// Stable shader binding identifier.
    /// </param>
    ...
    /// Exactly sixteen floating-point matrix values.
    /// </param>
    public abstract void SetTransform(ReadOnlySpan<float> columnMajorMatrix);

    /// <summary>
    /// Overrides raster state for subsequent draws in the current pass.
    /// </summary>
    /// <param name="state">
    /// Complete backend-neutral raster state.
    /// </param>
    public abstract void SetRasterState(RenderRasterState state);

    /// <summary>
    /// Sets two-sided stencil state for subsequent draws.
    /// </summary>
    /// <param name="state">
    /// Complete backend-neutral stencil state.
    /// </param>
    public abstract void SetStencil(RenderStencilState state);

    /// <summary>
    /// Changes the viewport rectangle for the current pass view.
    /// </summary>
    /// <param name="x">
    /// Horizontal framebuffer origin.
    /// </param>
    /// <param name="y">
    /// Vertical framebuffer origin.
    /// </param>
    /// <param name="width">
    /// Positive framebuffer width.
    /// </param>
    /// <param name="height">
    ...
    /// <summary>
    /// Binds a graph buffer as index input.
    /// </summary>
    /// <param name="buffer">
    /// Index buffer.
    /// </param>
    ...
    /// <summary>
    /// Binds graph buffer elements as per-instance input.
    /// </summary>
    /// <param name="buffer">
    /// Vertex-compatible graph buffer containing instance records.
    /// </param>
    /// <param name="firstInstance">
    /// First instance element.
    /// </param>
    /// <param name="instanceCount">
    /// Positive bound instance count.
    /// </param>
    ...
    /// </summary>
    /// <param name="buffer">
    /// Vertex-compatible persistent buffer containing instance records.
    /// </param>
    /// <param name="firstInstance">
    /// First instance element.
    /// </param>
    ...
    /// </summary>
    /// <param name="buffer">
    /// Current-frame instance records.
    /// </param>
    ...
    /// </summary>
    /// <param name="vertexCount">
    /// Number of shader-generated vertices.
    /// </param>
    /// <param name="instanceCount">
    /// Number of instances.
    /// </param>
    ...
    /// Source subresource box.
    /// </param>
    /// <param name="destination">
    /// Copy destination texture.
    /// </param>
    /// <param name="destinationRegion">
    /// Destination origin and compatible extent.
    /// </param>
...
public sealed class RenderPassContext
{
    ...
    /// <summary>
    /// Gets the command encoder scoped to the current pass.
    /// </summary>
    public RenderCommandEncoder commands { get; }

    /// <summary>
    /// Gets the monotonic frame index.
    /// </summary>
...
/// Neutral pass payload type.
/// </typeparam>
/// <param name="passData">
/// Pass payload captured for this frame only.
/// </param>
/// <param name="context">
