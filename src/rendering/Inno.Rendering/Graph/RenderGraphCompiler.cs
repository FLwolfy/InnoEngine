...
internal static class RenderGraphCompiler
{
    ...
    /// </param>
    /// <param name="textures">
    /// The textures consumed by compile; ownership remains with the caller unless explicitly stated otherwise.
    /// </param>
    /// <param name="buffers">
    /// The buffers consumed by compile; ownership remains with the caller unless explicitly stated otherwise.
    /// </param>
    /// <param name="passes">
    /// The passes consumed by compile; ownership remains with the caller unless explicitly stated otherwise.
    /// </param>
    /// <param name="outputs">
    /// The outputs consumed by compile; ownership remains with the caller unless explicitly stated otherwise.
    /// </param>
    /// <returns>
    /// The validated render graph compile result that represents the completed operation.
    /// </returns>
