...
public sealed class ScriptReloadOptions
{
    ...
    /// <summary>
    /// Gets the minimum interval between full garbage-collection attempts for retired assembly generations.
    /// </summary>
    public TimeSpan unloadCollectionInterval { get; init; } = TimeSpan.FromMilliseconds(250);

    /// <summary>
    /// Gets the duration after which a retained collectible generation permanently faults this reload host.
    /// </summary>
    public TimeSpan unloadRetentionTimeout { get; init; } = TimeSpan.FromSeconds(30);
}
