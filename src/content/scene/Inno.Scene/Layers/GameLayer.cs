...
public readonly struct GameLayer : IEquatable<GameLayer>, IComparable<GameLayer>
{
    ...
    /// </summary>
    /// <param name="index">
    /// The layer index in the inclusive range from zero through thirty-one.
    /// </param>
    ...
    /// </summary>
    /// <returns>
    /// A signed value describing the relative index ordering.
    /// </returns>
    /// <param name="other">
    ...
    /// </summary>
    /// <param name="other">
    /// The layer to compare with this value.
    /// </param>
    /// <returns>
    /// <see langword="true"/> when both layers identify the same index.
    /// </returns>
    ...
    /// </summary>
    /// <param name="left">
    /// The first layer identifier.
    /// </param>
    /// <param name="right">
    /// The second layer identifier.
    /// </param>
    /// <returns>
