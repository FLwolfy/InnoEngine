...
{
    private static readonly ExecutionSlot<SceneWorld> S_CURRENT_SCOPE = new("scene world");
    ...
    {
        EnsureActive();
        IDisposable identityScope = m_identities.EnterScope();
        return new Scope(S_CURRENT_SCOPE.Enter(this), identityScope);
    }
