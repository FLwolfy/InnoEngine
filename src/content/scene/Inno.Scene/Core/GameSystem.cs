...
public abstract class GameSystem : EngineObject, ISerializable, ISceneLifecycleObject
{
    ...
    public bool enabled
    {
        ...
        set
        {
            bool next = value && this is not MissingGameSystem;
            if (m_enabled == next)
                return;
            m_enabled = next;
            if (m_scene is { isLoaded: true })
                m_scene.NotifyGameSystemActivationChanged(this);
        }
    }
    ...
    /// <summary>
    /// Restores this system to defaults when added or explicitly reset.
    /// </summary>
    ...
    /// <summary>
    /// Called once before the system first becomes active.
    /// </summary>
    ...
    /// <summary>
    /// Called when the system becomes active and enabled.
    /// </summary>
    ...
    /// <summary>
    /// Called when the system stops being active and enabled.
    /// </summary>
    ...
    /// <summary>
    /// Called before a system that entered runtime lifecycle is destroyed.
    /// </summary>
    ...
    /// <summary>
    /// Called during the fixed-rate scene stage. Use <c>Time.fixedDeltaTime</c> for step timing.
    /// </summary>
    ...
    /// <summary>
    /// Called during the variable-rate scene stage. Use <c>Time.deltaTime</c> for frame timing.
    /// </summary>
    ...
    /// <summary>
    /// Called during the late scene stage. Use <c>Time.deltaTime</c> for frame timing.
    /// </summary>
    ...
    /// The component base or concrete type included in the result.
    /// </typeparam>
    /// <returns>
    ...
    /// </summary>
    /// <typeparam name="T1">
    /// The first component type required on every returned game object.
    /// </typeparam>
    /// <returns>
    /// An immutable snapshot of the values selected by the operation.
    /// </returns>
    ...
    /// </typeparam>
    /// <typeparam name="T2">
    /// The second component type required on every returned game object.
    /// </typeparam>
    /// <returns>
    /// An immutable snapshot of the values selected by the operation.
    /// </returns>
    ...
    /// </typeparam>
    /// <typeparam name="T3">
    /// The third component type required on every returned game object.
    /// </typeparam>
    /// <returns>
    /// An immutable snapshot of the values selected by the operation.
    /// </returns>
