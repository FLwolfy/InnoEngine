...
public sealed partial class PlatformImGuiContext : IDisposable
{
    ...
    /// </summary>
    /// <param name="style">
    /// The style represented by the font file.
    /// </param>
    /// <param name="filePath">
    /// Path to a TrueType or OpenType font.
    /// </param>
    /// <param name="fontSizePixels">
    /// Unscaled font size in pixels.
    /// </param>
    /// <exception cref="InvalidOperationException">
    /// Thrown after the first ImGui frame has started.
    /// </exception>
    ...
    /// </summary>
    /// <param name="filePath">
    /// Absolute or relative layout file path, or <see langword="null"/> to disable persistence.
    /// </param>
    /// <exception cref="InvalidOperationException">
    /// Thrown after the first ImGui frame has started.
    /// </exception>
    ...
    /// </summary>
    /// <param name="settings">
    /// The Dear ImGui layout text, or an empty string when no layout exists.
    /// </param>
    /// <exception cref="InvalidOperationException">
    /// Thrown after the first ImGui frame has started.
    /// </exception>
    ...
    /// </summary>
    /// <param name="settings">
    /// The complete Dear ImGui layout text when capture succeeds.
    /// </param>
    /// <param name="force">
    /// Whether to capture even when Dear ImGui did not request persistence.
    /// </param>
    /// <returns>
    ...
    /// Draw callback that issues ImGui commands for this frame.
    /// </param>
    /// <returns>
    /// The native pointer to <c>ImDrawData</c> for the rendered frame.
    /// </returns>
    public partial IntPtr RenderFrame(Action drawFrame);

    /// <summary>
    /// Draws a renderer-registered texture without exposing a native ImGui texture identifier.
    /// </summary>
    /// <param name="texture">
    /// Opaque token allocated by the active presentation backend.
    /// </param>
    /// <param name="size">
    /// Displayed size in logical ImGui pixels.
    /// </param>
    /// <param name="uv0">
