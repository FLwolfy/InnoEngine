...
public sealed class ScriptingApiNamespaceAttribute : Attribute
{
    ...
    /// </summary>
    /// <param name="name">
    /// The stable script API namespace, such as <c>InnoEngine.Scene</c>.
    /// </param>
    /// <param name="implementationNamespace">
    /// The CLR namespace containing exported runtime types.
    /// </param>
    /// <param name="scope">
    /// The script profile that receives the mapping.
    /// </param>
