...
/// <summary>Maps one isolated asset source to a controlled physical root.</summary>
public sealed class AssetSourceMount
{
    /// <summary>Creates an asset source mount.</summary>
    /// <param name="id">Stable source identity.</param>
    /// <param name="rootPath">Absolute or resolvable physical source root.</param>
    /// <param name="isReadOnly">Whether all source mutations must be rejected.</param>
    /// <param name="dependencies">Other read-only sources this source may reference.</param>
    ...
    /// <summary>Gets the controlled physical source root.</summary>
    public string rootPath { get; }

    /// <summary>Gets whether source mutations are forbidden.</summary>
    public bool isReadOnly { get; }

    /// <summary>Gets explicitly declared cross-source dependencies.</summary>
    public IReadOnlySet<AssetSourceId> dependencySourceIds { get; }

    /// <summary>Resolves a source-local path and rejects physical root escape.</summary>
    /// <param name="localPath">Source-local path.</param>
    /// <returns>An absolute path contained by this mount.</returns>
