...
/// <summary>
/// Defines which physical entries are excluded from an asset source tree.
/// </summary>
public sealed class AssetSourcePolicy
{
    ...
    /// <summary>
    /// Creates a source policy using the engine's default noise filters.
    /// </summary>
    ...
    /// <summary>
    /// Creates a source policy with additional ignored names and affixes.
    /// </summary>
    /// <param name="ignoredFileNames">
    /// Additional case-insensitive file names excluded from every source mount.
    /// </param>
    /// <param name="ignoredDirectoryNames">
    /// Additional case-insensitive directory names excluded with their descendants.
    /// </param>
    /// <param name="ignoredPrefixes">
    /// Additional file-name prefixes treated as transient authoring noise.
    /// </param>
    /// <param name="ignoredSuffixes">
    /// Additional file-name suffixes treated as transient authoring noise.
    /// </param>
    public AssetSourcePolicy(
    ...
    /// <summary>
    /// Gets the default source policy.
    /// </summary>
    public static AssetSourcePolicy defaultPolicy { get; } = new();

    /// <summary>
    /// Determines whether an entry is excluded from the source database.
    /// </summary>
    /// <param name="relativePath">
    /// The normalized path relative to its owning source mount.
    /// </param>
    ...
    /// <summary>
    /// Determines whether a path is generated asset metadata.
    /// </summary>
    /// <param name="relativePath">
    /// The normalized path relative to its owning source mount.
    /// </param>
