...
/// <summary>Identifies the physical container used to install a local Plugin.</summary>
public enum PluginSourceKind
{
    /// <summary>The Plugin is installed as one source ZIP.</summary>
    Zip,

    /// <summary>The Plugin is installed as an unpacked source directory.</summary>
    Directory
}

/// <summary>Controls bounded validation and ZIP extraction for installed Plugin sources.</summary>
public sealed class PluginSourceLimits
{
    /// <summary>Gets default conservative local Plugin limits.</summary>
    public static PluginSourceLimits defaults { get; } = new();

    /// <summary>Gets or initializes the maximum number of source entries.</summary>
    public int maximumEntryCount { get; init; } = 100_000;

    /// <summary>Gets or initializes the maximum size of one source file.</summary>
    public long maximumFileBytes { get; init; } = 64L * 1024 * 1024;

    /// <summary>Gets or initializes the maximum total source size.</summary>
    public long maximumTotalBytes { get; init; } = 1024L * 1024 * 1024;

    /// <summary>Gets or initializes the maximum accepted ZIP uncompressed-to-compressed ratio.</summary>
    public double maximumCompressionRatio { get; init; } = 200d;
}

/// <summary>Describes one validated installed Plugin source candidate.</summary>
public sealed class PluginCandidate
{
    ...
    /// <summary>Gets the installed ZIP or directory path.</summary>
    public string sourcePath { get; }

    /// <summary>Gets the physical source container kind.</summary>
    public PluginSourceKind sourceKind { get; }

    /// <summary>Gets the deterministic complete source-content hash.</summary>
    public string contentHash { get; }

    /// <summary>Gets the validated native manifest.</summary>
    public PluginManifest manifest { get; }

    /// <summary>Gets the isolated read-only asset source mount.</summary>
...
/// <summary>Reports one Plugin discovery, validation, or dependency problem.</summary>
public sealed class PluginDiagnostic
{
    /// <summary>Creates a Plugin source diagnostic.</summary>
    /// <param name="sourcePath">Related ZIP or directory path.</param>
    ...
    /// <summary>Gets the related ZIP or directory path.</summary>
    public string sourcePath { get; }
