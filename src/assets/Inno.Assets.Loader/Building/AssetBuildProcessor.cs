...
/// <summary>Defines an automatically discovered aggregate asset build processor.</summary>
...
/// <summary>Provides a strongly typed aggregate asset build processor.</summary>
/// <typeparam name="TDefinition">The definition asset type.</typeparam>
    ...
    where TDefinition : AssetObject
{
    ...
    /// <summary>Builds immutable outputs from a consistent asset snapshot.</summary>
    /// <param name="context">The build context.</param>
    /// <param name="output">The candidate output writer.</param>
    /// <param name="cancellationToken">Cancellation for the build.</param>
    /// <returns>An operation that completes when all outputs are staged.</returns>
