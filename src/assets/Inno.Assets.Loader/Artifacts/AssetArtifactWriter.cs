...
/// <summary>Collects immutable named outputs for an aggregate asset build.</summary>
public sealed class AssetArtifactWriter
{
    ...
    /// <summary>Writes one named build output.</summary>
    ...
    /// <summary>Adds a build diagnostic.</summary>
