...
public sealed class GameTagCatalog : ISerializable
{
    ...
    /// <summary>Gets the stable project setting protocol for the project-wide tag catalog.</summary>
    public static ProjectSettingId settingId => new("inno.scene.tags");

    /// <summary>Gets the defined tags with the immutable default tag first.</summary>
    /// <returns>An independently owned deterministic tag snapshot.</returns>
    ...
    /// <summary>Determines whether an ordinal tag is defined by the project.</summary>
    /// <param name="tag">The tag to resolve.</param>
    /// <returns><see langword="true"/> when the normalized tag is defined.</returns>
    /// <exception cref="ArgumentException">Thrown when <paramref name="tag"/> is empty or invalid.</exception>
    ...
    /// <summary>Adds one normalized project tag definition.</summary>
    /// <param name="tag">The unique tag to define.</param>
    /// <returns><see langword="true"/> when a definition was added.</returns>
    /// <exception cref="ArgumentException">Thrown when <paramref name="tag"/> is empty or invalid.</exception>
    ...
    /// <summary>Removes one custom project tag definition without rewriting scene assignments.</summary>
    /// <param name="tag">The custom tag to remove.</param>
    /// <returns><see langword="true"/> when an existing definition was removed.</returns>
    /// <exception cref="ArgumentException">Thrown when <paramref name="tag"/> is empty or invalid.</exception>
    ...
    /// <summary>Creates a detached mutable copy of this catalog.</summary>
    /// <returns>An independently owned catalog with the same definitions.</returns>
