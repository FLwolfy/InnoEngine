...
/// <summary>Composes sparse tag additions and removals from multiple setting contributors.</summary>
...
/// <summary>Stores sparse semantic operations for one GameTag setting contribution.</summary>
