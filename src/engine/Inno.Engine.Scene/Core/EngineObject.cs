...
/// </summary>
public abstract class EngineObject : IIdentityObject
{
    private bool m_isDestroyed;

    /// <summary>
    /// Gets the persistent and runtime identity associated with this object.
    /// </summary>
    ...
    /// <returns><see langword="true"/> when both operands refer to the same live object or both behave as null.</returns>
    ...
    /// <param name="left">Left operand.</param>
    /// <param name="right">Right operand.</param>
    /// <returns><see langword="true"/> when the operands do not represent the same object.</returns>
    ...
    /// <returns><see langword="true"/> when <paramref name="obj"/> is this instance.</returns>
    public override bool Equals(object? obj) => ReferenceEquals(this, obj);

    /// <summary>
    /// Returns a stable runtime reference hash code.
    /// </summary>
    /// <returns>The reference hash code.</returns>
    ...
    internal void RegisterIdentity(Guid? persistentId = null)
    {
        ...
        if (!IdentityManager.Register(this, persistentId))
    ...
    internal void MarkDestroyed()
    {
        ...
        try
        {
            IdentityManager.Unregister(this);
        }
        finally
        {
            m_isDestroyed = true;
