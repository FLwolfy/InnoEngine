...
public sealed class GameLayerStack : ISerializable
{
    ...
    /// <summary>Gets the stable project setting protocol for the project-wide layer catalog.</summary>
    ...
    /// <summary>Gets the logical identity assigned to a layer slot.</summary>
    /// <param name="layer">The layer slot to resolve.</param>
    /// <returns>The stable logical ID, or <see langword="null"/> when the slot is undefined.</returns>
    ...
    /// <summary>Tries to resolve a stable logical layer identity to its compact runtime slot.</summary>
    /// <param name="id">The globally stable layer identity.</param>
    /// <param name="layer">The resolved runtime slot when found.</param>
    /// <returns><see langword="true"/> when the identity is defined.</returns>
    ...
    /// <summary>Resolves a stable logical layer identity to its compact runtime slot.</summary>
    /// <param name="id">The globally stable layer identity.</param>
    /// <returns>The matching runtime layer slot.</returns>
    /// <exception cref="KeyNotFoundException">Thrown when the identity is not defined.</exception>
    ...
    /// <summary>Creates a mask from stable logical layer identities.</summary>
    /// <param name="ids">The logical identities whose runtime bits should be enabled.</param>
    /// <returns>A mask containing every resolved layer.</returns>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="ids"/> is <see langword="null"/>.</exception>
    /// <exception cref="KeyNotFoundException">Thrown when a supplied identity is not configured.</exception>
    ...
    /// <summary>Defines or updates one layer slot with an explicit globally stable identity.</summary>
    /// <param name="layer">The compact runtime slot to define.</param>
    /// <param name="id">The unique globally stable logical identity.</param>
    /// <param name="name">The unique non-empty display name.</param>
    /// <exception cref="ArgumentException">
