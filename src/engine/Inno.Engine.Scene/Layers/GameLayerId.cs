...
/// <summary>Identifies one logical game layer independently from its compact runtime slot.</summary>
public readonly record struct GameLayerId
{
    /// <summary>Gets the immutable built-in default layer identity.</summary>
    public static GameLayerId defaultLayer { get; } = new("inno.default");

    /// <summary>Creates a globally stable lowercase layer identity.</summary>
    /// <param name="value">A namespaced identifier containing lowercase letters, digits, dots, hyphens, or underscores.</param>
    /// <exception cref="ArgumentException">Thrown when <paramref name="value"/> is empty or not portable.</exception>
    ...
    /// <summary>Gets the globally stable identity string.</summary>
    public string value { get; }

    /// <summary>Gets whether this value contains a usable identity.</summary>
