...
/// <summary>Composes sparse logical layer and interaction contributions into one compact runtime stack.</summary>
...
/// <summary>Stores sparse semantic operations for one GameLayer setting contribution.</summary>
