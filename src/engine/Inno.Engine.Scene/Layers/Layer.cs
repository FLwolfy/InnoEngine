...
public readonly struct Layer : IEquatable<Layer>, IComparable<Layer>
{
    ...
    /// </summary>
    public static Layer defaultLayer { get; } = new(0);
    ...
    public int CompareTo(Layer other) => index.CompareTo(other.index);
    ...
    public bool Equals(Layer other) => index == other.index;
