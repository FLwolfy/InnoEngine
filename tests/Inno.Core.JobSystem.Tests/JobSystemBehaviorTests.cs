...
public sealed class JobSystemBehaviorTests
{
    ...
    {
        using var jobs = new SingleThreadJobSystem();
        jobs.BeginFrame();
    ...
    {
        using var jobs = new WorkStealingJobSystem(new JobSystemOptions { workerCount = 0 });
    ...
    private static WorkStealingJobSystem CreateWorkStealing(int workerCount = 2)
    {
