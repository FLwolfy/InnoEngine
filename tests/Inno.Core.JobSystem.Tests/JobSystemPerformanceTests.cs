...
public sealed class JobSystemPerformanceTests
{
    ...
    public void WorkStealingScheduleCompleteAll_IsFasterThanSingleThread()
    {
        ...
        using var single = new SingleThreadJobSystem();
    ...
    private static WorkStealingJobSystem CreateWorkStealing(int workerCount)
    {
        return new WorkStealingJobSystem(new JobSystemOptions
        {
    ...
    private static TimeSpan MeasureScheduleAndCompleteAll(IJobSystem jobs, int jobCount, int sleepMilliseconds)
    {
        jobs.BeginFrame();
    ...
    private static TimeSpan MeasureParallelFor(IJobSystem jobs, int length, int batchSize, int sleepMilliseconds)
    {
        jobs.BeginFrame();
