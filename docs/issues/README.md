...
本目录是架构问题、审查原文、正式设计决策、整改方案与关闭证据的唯一事实来源。
[架构治理](../architecture/CURRENT_ISSUES.md)只提供入口，不再维护第二份独立问题状态。
...
| 2026-08-31 | [全量问题台账](2026-08-31-complete-issue-register.md) | 36 项问题、最终 owner、关闭证据与不可妥协约束 |
